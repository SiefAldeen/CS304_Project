 ...
 * @author Sief Aldeen
 */
public class OnePlayer implements GLEventListener, MouseListener {
    boolean audioState;
    Clip clip;
    ...
    int player = 0;
//    double y = 0;
    String textureNames[] = {"red.png", "green.png", "Game.png", "paused.png", "Wining.png","LOSING.png"};
...
//                mipmapsFromPNG(gl, new GLU(), texture[i]);
    ...
    public void DrawSprite(GL gl, double x, double y, int index, float scale) {
        ...
        gl.glPushMatrix();
//        gl.glRotated(180, (x/(maxWidth/2.0) - 0.9)/2, (y/(maxHeight/2.0) - 0.9)/2, 0);
